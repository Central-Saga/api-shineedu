...
Must be one of:
<ul style="list-style-type: square;"><li><code>kode_karyawan</code></li> <li><code>status</code></li> <li><code>gaji_pokok</code></li> <li><code>created_at</code></li> <li><code>updated_at</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>sort_dir</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<div class="bash-example">
    ...
    \"nomor_hp\": \"v\",
    \"alamat\": \"d\",
    \"tanggal_lahir\": \"2026-01-20T03:47:41\",
    \"status\": \"nonaktif\"
}"
</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="2026-01-20T03:47:41"
               data-component="body">
    <br>
<p>validation.date. Example: <code>2026-01-20T03:47:41</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>status</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://api.shineeducationbali.test/api/v2/employees/16" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://api.shineeducationbali.test/api/v2/employees/16"
);
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the employee. Example: <code>16</code></p>
            </div>
                    </form>
